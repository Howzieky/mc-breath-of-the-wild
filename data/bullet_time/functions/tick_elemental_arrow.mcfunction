execute at @s[nbt={CustomPotionEffects:[{Amplifier:100b}]}] unless entity @e[type=player,distance=..2] run particle minecraft:item minecraft:ice ~ ~ ~ 0 0 0 .1 10 force
execute at @s[nbt={CustomPotionEffects:[{Amplifier:101b}]}] unless entity @e[type=player,distance=..2] run particle minecraft:flame ~ ~ ~ 0 0 0 .01 1 force
execute at @e[nbt={CustomPotionEffects:[{Amplifier:102b}]}] unless entity @e[type=player,distance=..2] run particle minecraft:smoke ~ ~ ~ 0 0 0 0 4 force
