...
execute if score galeCounter timers matches 0..4 if entity @s[tag=!galeReady,nbt={OnGround:1b},tag=!revaliDisabled,scores={sneakTime=15..}] run function bullet_time:prime_gale
