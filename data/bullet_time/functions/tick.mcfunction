...
team leave @e[type=!villager,team=noCollide,nbt=!{OnGround:0b,SelectedItem:{id:"minecraft:bow"}}]
...
execute unless score galeCounter timers matches 0..4 as @e[tag=crouching,tag=!paragliding,tag=!darukDisabled] at @s run function bullet_time:tick_prime_daruk
