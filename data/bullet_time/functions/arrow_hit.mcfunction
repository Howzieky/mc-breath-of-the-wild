...
execute if entity @s[nbt={ActiveEffects:[{Id:26b,Amplifier:104b}]}] run function bullet_time:arrow_hit_shock
...
execute if entity @s[nbt={CustomPotionEffects:[{Id:26b,Amplifier:104b}]}] run function bullet_time:arrow_hit_shock
