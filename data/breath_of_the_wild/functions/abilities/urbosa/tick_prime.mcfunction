...
execute unless predicate breath_of_the_wild:looking_at_stasis_frozen at @s as @e[tag=urbosaStand] rotated as @s run tp @s ~ ~ ~ ~-12.5 ~
execute if predicate breath_of_the_wild:looking_at_stasis_frozen at @s as @e[tag=urbosaStand] rotated as @s run tp @s ~ ~-2 ~ ~-12.5 ~
...
execute if score @s damageDealt matches 1.. unless entity @s[predicate=breath_of_the_wild:looking_at_stasis_frozen] run function breath_of_the_wild:abilities/urbosa/start_animation
