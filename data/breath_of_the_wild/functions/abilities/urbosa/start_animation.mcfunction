...
execute as @e[distance=..30,tag=!link,team=!ghostGlow,tag=!bowDetector,tag=!square_bomb,tag=!round_bomb] at @s run function breath_of_the_wild:effects/electrocute/start
#execute as @e[distance=..30,tag=!link,team=!ghostGlow,tag=!bowDetector] run say hello
