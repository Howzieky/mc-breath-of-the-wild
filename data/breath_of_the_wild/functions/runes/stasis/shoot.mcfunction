...
tag @e[tag=stasisTarget,limit=1] add recentStasis
...
data modify entity @e[tag=stasisTarget,limit=1] Motion set from storage minecraft:breath_of_the_wild tempEntity.Motion
