...
execute as @e[predicate=breath_of_the_wild:holding_carrot_on_a_stick] run function breath_of_the_wild:runes/tick_holding_cs
execute as @e[tag=holdingCS,predicate=!breath_of_the_wild:holding_carrot_on_a_stick] run function breath_of_the_wild:runes/end_holding_cs
...
execute as @s[tag=!delayedDeath] run function breath_of_the_wild:tools/update_scoreboards
...
execute if entity @s[tag=!staminaExhausted,tag=!climbJumping] if block ~ ~-1 ~ #breath_of_the_wild:intangible rotated ~ 0 positioned ^ ^ ^.35 unless block ~ ~ ~ #breath_of_the_wild:intangible run function breath_of_the_wild:climb/tick
execute if entity @s[tag=!staminaExhausted,tag=!climbJumping] if block ~ ~-1 ~ #breath_of_the_wild:intangible rotated ~ 0 positioned ^ ^ ^.35 if block ~ ~ ~ #breath_of_the_wild:intangible positioned ^ ^ ^.05 unless block ~ ~ ~ air run function breath_of_the_wild:climb/tick_stopped
execute if entity @s[tag=climbing] run function breath_of_the_wild:tick_climb_movement_check
execute if entity @s[tag=climbing,tag=!climbJumpEnabled] rotated ~ 0 positioned ^ ^ ^.43 if block ~ ~ ~ #breath_of_the_wild:intangible run function breath_of_the_wild:climb/end
...
execute if entity @s[tag=!climbing,tag=!bulletTime,tag=!paragliding,predicate=breath_of_the_wild:on_ground] if score @s stamina < @s staminaMax run scoreboard players add @s stamina 5
