...
scoreboard players operation @s[type=#breath_of_the_wild:mass/large] mass = large mass
scoreboard players operation @s[type=#breath_of_the_wild:mass/huge] mass = huge mass
